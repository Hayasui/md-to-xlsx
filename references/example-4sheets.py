...
> **这份样例保留的是当时交付的原样，命名上早于 2026-09-10 的规范调整。**
> 其中问卷末列仍叫「判定」，现在统一叫「问卷逻辑」；
> 列名统一，语义不变，判定与跳转都记在触发它的那一行上。
> 写新脚本请以 scripts/build_research_xlsx.py 为准。
...
模板见 scripts/build_research_xlsx.py。
